...
const siteConfig = {
  ...
  headerLinks: [
    {doc: 'what_is_liko-12', label: 'Docs'},
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} The LIKO-12 Organization`,
  ...
  editUrl: 'https://github.com/LIKO-12/WIP/edit/master/docs/'
};
